 ...
 */
export default function useCalendarUser(date = new Date(), pageNumber = 0, pageSize = 10, refresh = 0) {
    ...
    useEffect(() => {
        ...
        const fetchCalendarEvents = async () => {
            try {
                ...
                const { data, status } = await CalendarService.getEventsUser({ date, pageNumber, pageSize });
